...
export default function AvailabilitySearchBar({
  ...
  return (
    <>
      {/* Mobile — unchanged for now, redesign pending a separate pass */}
      <div className="lg:hidden bg-white border border-gray-200 rounded-lg shadow-sm">
        <div className="flex flex-col divide-y divide-gray-200">
          ...
          <div className="p-2.5">
            <button
              ...
              className="w-full bg-black text-white text-sm font-medium px-8 py-2.5 rounded-md hover:bg-brand transition-colors"
            >
              Search
            </button>
          </div>
        ...
        <div className="flex divide-x divide-gray-200">
          ...
          <div className="p-3 flex items-center">
            <button
              type="button"
              onClick={handleSearch}
              className="bg-black text-white text-sm font-medium px-8 py-4 rounded-md hover:bg-brand transition-colors"
            >
              Search
            </button>
          </div>
