...
ALTER TABLE public.google_shopping_sync_logs DROP CONSTRAINT google_shopping_sync_logs_status_check;
ALTER TABLE public.google_shopping_sync_logs
  ADD CONSTRAINT google_shopping_sync_logs_status_check CHECK (status IN ('success', 'partial', 'error'));

ALTER TABLE public.google_shopping_sync_automation DROP CONSTRAINT google_shopping_sync_settings_last_run_status_check;
ALTER TABLE public.google_shopping_sync_automation
