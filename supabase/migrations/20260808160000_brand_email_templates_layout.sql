...
UPDATE vertex.automatic_emails SET subject = 'Your order #{order_number} is confirmed!', html_content = '<div style="background:#f3f4f6;padding:24px 12px;font-family:Arial,Helvetica,sans-serif">
  ...
  <div style="max-width:560px;margin:0 auto">
    <div style="text-align:center;padding:20px 0">
      <img src="https://vertex-rental-cars.vercel.app/images/store-logo.png" alt="Vertex Rental Cars" style="height:40px;width:auto" />
    </div>
...
<p style="margin:0 0 14px;line-height:1.6;color:#374151"><span style="font-size:13px;color:#9ca3af">Use this code on your next order.</span></p>
    ...
    <div style="text-align:center;padding:24px 12px;color:#9ca3af;font-size:12px;line-height:1.6">
      <p style="margin:0 0 10px">
        ...
        &middot;
        <a href="https://vertex-rental-cars.vercel.app" style="color:#6b7280;text-decoration:none;margin:0 8px">vertex-rental-cars.vercel.app</a>
      </p>
      <p style="margin:0">&copy; 2026 Vertex Rental Cars. All rights reserved.</p>
    </div>
  </div>
</div>', updated_at = NOW() WHERE trigger_key = 'order_confirmation';

UPDATE vertex.automatic_emails SET subject = 'Your order #{order_number} has shipped!', html_content = '<div style="background:#f3f4f6;padding:24px 12px;font-family:Arial,Helvetica,sans-serif">
...
UPDATE vertex.automatic_emails SET subject = 'Your order #{order_number} was delivered!', html_content = '<div style="background:#f3f4f6;padding:24px 12px;font-family:Arial,Helvetica,sans-serif">
...
UPDATE vertex.automatic_emails SET subject = 'Your order #{order_number} was cancelled', html_content = '<div style="background:#f3f4f6;padding:24px 12px;font-family:Arial,Helvetica,sans-serif">
...
UPDATE vertex.automatic_emails SET subject = 'Your refund for order #{order_number} has been processed', html_content = '<div style="background:#f3f4f6;padding:24px 12px;font-family:Arial,Helvetica,sans-serif">
...
UPDATE vertex.automatic_emails SET subject = 'Welcome! Here''s 10% off your first order', html_content = '<div style="background:#f3f4f6;padding:24px 12px;font-family:Arial,Helvetica,sans-serif">
  ...
  <div style="max-width:560px;margin:0 auto">
    ...
    <div style="background:#ffffff;border-radius:10px;padding:32px;color:#1f2937">
<h1 style="color:#111827;font-size:20px;margin:0 0 16px">Welcome to Vertex Rental Cars!</h1>
...
<p style="text-align:center;margin:24px 0"><a href="https://vertex-rental-cars.vercel.app" style="background:#db3614;color:#fff;padding:12px 28px;border-radius:6px;text-decoration:none;font-weight:bold;display:inline-block">Shop now</a></p>
<p style="margin:0 0 14px;line-height:1.6;color:#374151"><span style="font-size:12px;color:#9ca3af">You''re receiving this because you subscribed at vertex-rental-cars.vercel.app. You can unsubscribe any time by replying to this email.</span></p>
    </div>
    <div style="text-align:center;padding:24px 12px;color:#9ca3af;font-size:12px;line-height:1.6">
      <p style="margin:0 0 10px">
        <a href="https://instagram.com/cosmeticmarketplace" style="color:#6b7280;text-decoration:none;margin:0 8px">Instagram</a>
...
UPDATE vertex.automatic_emails SET subject = 'You left something in your cart', html_content = '<div style="background:#f3f4f6;padding:24px 12px;font-family:Arial,Helvetica,sans-serif">
...
<p style="margin:0 0 14px;line-height:1.6;color:#374151"><span style="font-size:12px;color:#9ca3af">You''re receiving this because you started a checkout at vertex-rental-cars.vercel.app. You can unsubscribe any time by replying to this email.</span></p>
    </div>
    <div style="text-align:center;padding:24px 12px;color:#9ca3af;font-size:12px;line-height:1.6">
      <p style="margin:0 0 10px">
        <a href="https://instagram.com/cosmeticmarketplace" style="color:#6b7280;text-decoration:none;margin:0 8px">Instagram</a>
