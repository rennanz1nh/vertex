...
CREATE TABLE IF NOT EXISTS public.zernio_social_accounts (
...
ALTER TABLE public.zernio_social_accounts ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Service role manages zernio social accounts"
  ON public.zernio_social_accounts
  FOR ALL
  TO service_role
  USING (true)
  WITH CHECK (true);
